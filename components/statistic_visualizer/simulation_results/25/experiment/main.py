...
def run_simulation(real_time: bool):
    ...
    builder.add_node(ZigZagProtocolMobile, (-600.0, -300.0, 0.0))
    builder.add_node(ZigZagProtocolMobile, (-600.0, 0.0, 0.0))
    builder.add_node(ZigZagProtocolMobile, (-600.0, 300.0, 0.0))
    builder.add_node(ZigZagProtocolMobile, (-600.0, 600.0, 0.0))
    builder.add_node(ZigZagProtocolMobile, (-300.0, -600.0, 0.0))
    builder.add_node(ZigZagProtocolMobile, (-300.0, -300.0, 0.0))
    builder.add_node(ZigZagProtocolMobile, (-300.0, 0.0, 0.0))
    builder.add_node(ZigZagProtocolMobile, (-300.0, 300.0, 0.0))
    builder.add_node(ZigZagProtocolMobile, (-300.0, 600.0, 0.0))
    builder.add_node(ZigZagProtocolMobile, (0.0, -600.0, 0.0))
    builder.add_node(ZigZagProtocolMobile, (0.0, -300.0, 0.0))
